                                    ...
                                    <table class="table table-sm table-striped table-bordered table-hover ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center">$ {{ number_format($tmp_compra->producto->precio_compra, 0, ',', '.') }}</td>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="text-align:center; background-color:gold"  class="form-control"value="$ {{ number_format($total_compra, 0, ',', '.') }}" name="precio_total" required >
                                            @error('precio_total')
                                            <small style="color:red;">{{$message}}</small>
                                            @enderror
                                        </div>
